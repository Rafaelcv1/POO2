...
public class Main {
    static void main(String[] args) {
        ...
        Interessado painel = new PainelEstoque();
        Interessado alerta = new AlertaReposicao();

        notebook.inscrever(painel);
        notebook.inscrever(alerta);
 ...
 *
 * <p>
 * Versão atualizada, não possui acoplamento direto com as classes que reagem às
...
class ProdutoEstoque {
    ...
    private final List<Interessado> interessados = new ArrayList<>();
    ...
    /**
     * Adiciona o interessado em atualizacoes na lista interessado.
     *
    ...
    private void notificarAlteracao() {
        for (Interessado interessado : interessados) {
            interessado.receberNotificacao(this);
        }
    }
...
interface Interessado {
    public void receberNotificacao(ProdutoEstoque produto);
}
/**
